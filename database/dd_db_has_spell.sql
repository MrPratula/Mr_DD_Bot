...
--
-- Table structure for table `has_spell`
--

DROP TABLE IF EXISTS `has_spell`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `has_spell` (
  `char_id` int NOT NULL,
  `spell_name` varchar(255) NOT NULL,
  PRIMARY KEY (`char_id`,`spell_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `has_spell`
--

LOCK TABLES `has_spell` WRITE;
/*!40000 ALTER TABLE `has_spell` DISABLE KEYS */;
/*!40000 ALTER TABLE `has_spell` ENABLE KEYS */;
UNLOCK TABLES;
