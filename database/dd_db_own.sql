...
CREATE TABLE `own` (
  ...
  CONSTRAINT `char_id` FOREIGN KEY (`char_id`) REFERENCES `character` (`char_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`chat_id`) ON UPDATE CASCADE
